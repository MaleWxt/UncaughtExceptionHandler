...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        Log.i("CrashHandler", "---uncaughtException()--->" + "UncaughtException发生");
        if (!handleException(ex) && mDefaultHandler != null) {
            // 如果用户没有处理 则让系统默认的异常处理器来处理
            mDefaultHandler.uncaughtException(thread, ex);
        } else {
            Log.i("CrashHandler", "---uncaughtException()--->" + "自定义处理");
            //自定义处理逻辑
    ...
    private String saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            trace.flush();
            trace.close();
            Log.i("CrashHandler", "---saveCrashInfoToFile()--->" + "保存成功");
            return fileName;
        } catch (Exception e) {
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            if (pi != null) {
                ...
                Log.i("CrashHandler", "---collectCrashDeviceInfo()--->name   " + pi.versionName);
                Log.i("CrashHandler", "---collectCrashDeviceInfo()--->code   " + pi.versionCode);
            }
        ...
        for (Field field : fields) {
            try {
                ...
                Log.i("CrashHandler", "---collectCrashDeviceInfo()--->设备信息   " + field.getName()
                        + " : " + field.get(null));
                if (DEBUG) {
